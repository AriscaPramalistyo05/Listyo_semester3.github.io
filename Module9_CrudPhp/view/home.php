...
<div class="container">
    <h1 class="text-center">Data to perform CRUD Operationa</h1>
    <a href="create.php" class="btn btn-outlines-dark mb-2"><i class="table table-stripped table-bordered table-hover"></i></a>
    ...
    <tbody>
        <tr>
            ...
            while ($row = mysqli_fetch_array($view_users)) {
                $id = $row['ID'];
                $user = $row['username'];
                $email = $row['email'];
                $pass = $row['password'];
