...
// $queryTerkait = mysqli_fetch_array($queryProdukTerkait);
// var_dump($queryTerkait);
    ...
    <div class="row px-xl-5">
      <div class="col-lg-5 pb-5">
        <div class="carousel-item active">
          <img class="w-100 h-100" src="img/<?php echo $produk['foto']; ?>" alt="Image" />
        </div>
      </div>

      <div class="col-lg-7 pb-5">
        <h3 class="font-weight-semi-bold"><?php echo $produk['nama']; ?></h3>
        ...
        <p class="mb-4 " style="font-weight: bold;">Ketersediaan Stok : <?php echo $produk['ketersediaan_stok']; ?></p>
        <div class="d-flex mb-3">
        ...
        <a href="add.php?nama=<?php echo $produk['nama']; ?>" class="btn btn-primary px-3">
    ...
    <div class="col">
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="tab-pane-1">
          ...
          <p>
            <?php echo $produk['deskripsi_prod']; ?>
          </p>
        </div>
            ...
            <div class="card product-item border-0">
              ...
              <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                ...
                <div class="d-flex justify-content-center">
                  <h6>Rp <?php echo $data['harga']; ?></h6>
                  <h6 class="text-muted ml-2"><del>$123.00</del></h6>
                </div>
              </div>
              <div class="card-footer d-flex justify-content-between bg-light border">
                <a href="detail.php?nama=<?php echo urlencode($data['nama']); ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
